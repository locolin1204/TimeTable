...
guessField.addEventListener('keypress', typeEnter);
...
ansButton.addEventListener('click', showAns);
...
function showAns(){
    if(!textNode){
        textNode = document.createTextNode('Answer:'+ randomNumber);
    } else{
        textNode.textContent = 'Answer:'+ randomNumber;
    }
